...
%  EXMAPP provides an interface to twenty of the graphical experiments
%  from "Experiments with MATLAB".  Click on any icon to access the
%  underlying function.
%     fern       biorythm   clockex    lifex      rabbits
%     pagerank   wiggle     t_puzzle   tictactoe  backslash
%     predprey   mandelbrot durerperm  waterwave  expshow
%     sudoku     orbits     morse_code pianoex    golden_spiral
...
for k = 1:20
   ...
   switch k
      ...
      case 15, xexpshow; f = @expshow; s = 'expshow';
      case 16, xsudoku; f = @sudoku; s = 'sudoku';
      case 17, xorbits; f = @orbits; s = 'orbits'; 
      case 18, xmorse; f = @morse_code; s = 'morse\_code';
      case 19, xpianoex; f = @pianoex; s = 'pianoex';
      case 20, xspiralex; f = @golden_spiral; s = 'golden\_spiral';
   end
