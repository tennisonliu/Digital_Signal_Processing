function morse_code(arg)
% MORSE_CODE Interactive demonstration of Morse code and binary trees.
...
%   Copyright 2014 The MathWorks, Inc.
   ...
   function init_code
      ...
      clf reset
      shg
      set(gcf,'menubar','none','numbertitle','off','name','Morse_code')
      axes('pos',[0 0 1 1])
      axis(16*[-1 1 0 2])
      axis square off
      set(gcf,'color','white')
      ...
      uicontrol('style','edit','string', ...
         ...
         'callback','cla, morse_code(''_translate'')')
   end
